...
screens = [
    Screen(
        top=bar.Bar(
            widgets=[widget.Spacer(length=widget_left_offset, decorations=[])] + left + [widget.WindowName(foreground=theme['text'])] + right + [widget.Spacer(length=widget_right_offset, background=theme['dark2'])],
            size=bar_size,
