...
screens = [
    Screen(
        top=bar.Bar(
            widgets=[widget.Spacer(length=widget_left_offset, background=theme['dark2'])] + left + [widget.WindowName(foreground=theme['text'])] + right + [widget.Spacer(length=widget_right_offset, background=theme['dark'])],
            size=bar_size,
